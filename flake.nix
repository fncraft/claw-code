{
  ...
  outputs = { self, nixpkgs, flake-utils }:
    let
      mkClaw = pkgs: pkgs.rustPlatform.buildRustPackage {
        pname = "claw";
        version = "0.1.0";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        packages.default = mkClaw pkgs;
        packages.claw = mkClaw pkgs;
      ...
      # Overlay so home-manager / NixOS configs can add claw to pkgs
